...
(function($) {
    ...
    * according to the GMT+0 Timezone
    **/
    /*var launch = new Date(2016, 0, 20, 8, 00);*/
    var launch1 = new Date(2016, 0, 31, 9, 00);
    /**
    * The script
    **/
    ...
    function setDate(){
        ...
        if( launch1 < now ){
            ...
            var s = -now.getTimezoneOffset()*60 + (launch1.getTime() - now.getTime())/1000;
            var d = Math.floor(s/86400);
            days.html('<h1>'+d+'</h1><p>Day'+(d>1?'s':''),'</p>');
            s -= d*86400;
...
(function($) {
    ...
    **/
    /*var launch = new Date(2016, 0, 20, 8, 00);*/
    var launch2 = new Date(2016, 1, 01, 10, 00);
    /**
    * The script
    **/
